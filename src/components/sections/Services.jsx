  ...
  return (
    <section id="services" className="section overflow-hidden">
      <div className="container-wide">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px rounded-2xl overflow-hidden bg-white/[0.06] border border-white/[0.06]">
...
function ServiceTile({ service }) {
  ...
  return (
    <div className="group relative h-full bg-ink-900 hover:bg-ink-850 transition-colors duration-300 p-7 overflow-hidden">
      ...
      <div className="w-11 h-11 rounded-lg bg-brand-500/15 border border-brand-500/30 flex items-center justify-center text-brand-200 mb-5 group-hover:bg-brand-500/25 group-hover:border-brand-500/40 transition-colors">
